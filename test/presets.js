...
describe('temperature presets', function() {
  it('should convert correctly', function() {
    (40).should.be.exactly(convert(40, invert(temp.celsius_celsius)), 'celsius_celsius')
      .and.exactly(convert(104, invert(temp.celsius_fahrenheit)), 'celsius_fahrenheit')
    ...
    (0).should.be.exactly(convert(0, invert(temp.celsius_celsius)), 'celsius_celsius')
      .and.exactly(convert(32, invert(temp.celsius_fahrenheit)), 'celsius_fahrenheit')
